...
const NoiseStateMachineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_noisestatemachine_free(ptr >>> 0));
/**
...
export class NoiseStateMachine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        NoiseStateMachineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_noisestatemachine_free(ptr);
    }
    /**
    * @param {boolean} role
    ...
    */
    constructor(role, callback_up, callback_down, server_static_key) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(server_static_key, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.noisestatemachine_new_init(retptr, role, addHeapObject(callback_up), addHeapObject(callback_down), ptr0, len0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('potato_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
